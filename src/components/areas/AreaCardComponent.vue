...
export default class AreaCardComponent extends Vue.with(Props) {
  ...
  floorplanSelectionOptions = setup<Ref<string[]>>(() => ref(['Floorplan 01', 'Floorplan 02', 'Floorplan 03']))

  edgeMarkerSelectionToggle = setup<Ref<string>>(() => ref(''))
  edgeMarkerSelectionOptions = setup<Ref<string[]>>(() => ref(['Edge Marker 01', 'Edge Marker 02', 'Edge Marker 03']))
